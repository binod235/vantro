...
export function quoteChaseFirstHtml(data: {
  customerName: string;
  companyName: string;
  companyEmail: string;
  quoteNumber: string;
  ...
  return `
    <div style="font-family:Arial,sans-serif;max-width:600px;margin:0 auto;color:#1a1a1a;">
      <div style="background:#1d4ed8;padding:24px 32px;border-radius:8px 8px 0 0;">
        ...
        <p style="color:rgba(255,255,255,0.8);margin:4px 0 0;font-size:13px;">Quote Follow-Up</p>
      </div>
      <div style="border:1px solid #e5e7eb;border-top:none;border-radius:0 0 8px 8px;padding:32px;">
        ...
        <p style="margin:0 0 20px;color:#555;line-height:1.6;">
          I wanted to follow up on the quote we sent you — <strong>${data.quoteNumber}</strong>
          for <strong>${gbp(data.totalPence)}</strong>.
          If you have any questions or would like to discuss anything, please do get in touch.
        </p>
